...
export default class UserInterface extends GUI {
    constructor(thumbRaiser) {
        ...
        buildingFolder.domElement.style.fontSize = fontSize;
        buildingFolder.add(thumbRaiser.buildingParameters, "name", {
            "Building A": "buildingA",
            "Building B": "buildingB",
            "Building C": "buildingC",
            "Building D": "buildingD",
        }).name("Building").listen();

        // Create the floor list

        let floors;

        switch (thumbRaiser.buildingParameters.name) {
          case "buildingA":
            floors = buildingFolder.add(thumbRaiser.mazeParameters, "url", {
              "Floor 1 Building A": "./assets/floors/floor1_buildingA.json",
              "Floor 2 Building A": "./assets/floors/floor2_buildingA.json",
            }).name("Floor").listen();
            break;
          case "buildingB":
            floors = buildingFolder.add(thumbRaiser.mazeParameters, "url", {
              "Floor 1 Building B": "./assets/floors/floor1_buildingB.json",
              "Floor 2 Building B": "./assets/floors/floor2_buildingB.json",
              "Floor 3 Building B": "./assets/floors/floor3_buildingB.json",
            }).name("Floor").listen();
            break;
          case "buildingC":
            floors = buildingFolder.add(thumbRaiser.mazeParameters, "url", {
              "Floor 1 Building C": "./assets/floors/floor1_buildingC.json",
              "Floor 2 Building C": "./assets/floors/floor2_buildingC.json",
              "Floor 3 Building C": "./assets/floors/floor3_buildingC.json",
              "Floor 4 Building C": "./assets/floors/floor4_buildingC.json",
            }).name("Floor").listen();
            break;
          case "buildingD":
            floors = buildingFolder.add(thumbRaiser.mazeParameters, "url", {
              "Floor 1 Building D": "./assets/floors/floor1_buildingD.json",
              "Floor 2 Building D": "./assets/floors/floor2_buildingD.json",
              "Floor 3 Building D": "./assets/floors/floor3_buildingD.json",
            }).name("Floor").listen();
            break;

        }

      let confirmOption = buildingFolder.add({ Confirm: () => thumbRaiser.changeFloor() }, "Confirm");

      buildingFolder.onChange(() => {
          const selectedBuilding = thumbRaiser.buildingParameters.name;
          floors.destroy();
          ...
          confirmOption.destroy();
          confirmOption = buildingFolder.add({ Confirm: () => thumbRaiser.changeFloor() }, "Confirm");
        });
        ...
        // Create the skyboxes folder and add visualization-3D textures
